...
const MESSAGES = {
  zh: {
    ...
    tagRepeat: '循环播放',
    tagWantToGo: '想去打卡',
    postCommentPlaceholder: '写下你的聆听感受、旅行记忆与寄语…',
    regionalMode: '地域调式',
  ...
  en: {
    ...
    commentsInteraction: 'Comments & Wishes',
    storyTab: 'Poetic Story',
    commentsTab: 'Comments',
    backToGlobe: 'Back to Globe',
    tagComfortable: 'Pure Comfort',
    tagHealing: 'Deep Healing',
    tagRepeat: 'On Repeat',
    tagWantToGo: 'Must Visit',
    postCommentPlaceholder: 'Share your thoughts and wishes for this place…',
    ...
    leaderboardTitle: '🔥 Popular Soundscapes Chart',
