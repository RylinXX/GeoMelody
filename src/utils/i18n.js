...
const MESSAGES = {
  zh: {
    documentTitle: 'GeoMelody - 3D 沉浸式全球视听体验',
    ...
    settingsDisplaySection: '显示模式',
    settingFullscreen: '全屏浏览',
    settingFullscreenDesc: '隐藏浏览器界面，沉浸查看地球与播放器',
    ...
    tempoLabel: '节奏',
    locateMe: '我的',
    locateMeTitle: '定位循环：当前位置、街道级、清除定位',
    locating: '正在获取实时位置…',
  ...
  en: {
    ...
    settingsDisplaySection: 'Display Mode',
    settingFullscreen: 'Fullscreen View',
    settingFullscreenDesc: 'Hide browser chrome for an immersive globe and player experience',
    ...
    nextSpot: 'Next place (Right Arrow)',
    mute: 'Mute / Unmute',
    ...
    tempoLabel: 'Tempo',
    locateMe: 'Locate Me',
    locateMeTitle: 'Location cycle: current position, street level, clear marker',
    flightRoaming: 'Local Cruising Active',
